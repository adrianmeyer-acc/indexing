<?php
  ...
  // *******************************************************************
  // PHP to scrape all last names from www.behindthename.com 
  // *******************************************************************
  ...
  function fetchSynonyms( $aName ) {
		$parser = new HTMLDocument();
  	$url = "http://surnames.behindthename.com/names/extra.php?extra=r&terms=".urldecode( mb_strtoupper( $aName->name ));
  ...
  // ****************************************************************
  $phpFile = fopen("index.processor.lastname.php", "w");
